...
enum ScriptMeta {
	...
	ScriptMeta_Name
} ENUM_END_LIST(ScriptMeta);

enum PYFN_FLAGS
{
	PYFN_FLAGS_VARARGS = 0x0001,
	PYFN_FLAGS_KEYWORDS = 0x0002,
	PYFN_FLAGS_NOARGS = 0x0004,
	PYFN_FLAGS_STATIC = 0x0020,
	//////////////////////////////////////////////////////////////////////////
	PYFN_FLAGS_0 = 0
} ENUM_END_FLAGS(PYFN_FLAGS);

enum XPYCOMPILERINPUT
{
	XPYCOMPILERINPUT_SINGLE = 256, // Py_single_input
	XPYCOMPILERINPUT_FILE 	= 257, // Py_file_input
	XPYCOMPILERINPUT_EVAL 	= 258, // Py_eval_input
} ENUM_END_FLAGS(XPYCOMPILERINPUT);// yes, we need flags here

#define PYFN_FLAGS_ARGS_KEYWORDS (PYFN_FLAGS_VARARGS|PYFN_FLAGS_KEYWORDS)
...
{
public:
	PythonMethodData() { m_Flags = PYFN_FLAGS_0; m_pName = nullptr; m_pHelp = nullptr; }
