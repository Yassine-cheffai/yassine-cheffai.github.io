...
Bool PaintManager::ResetActiveView(){ PaintLibCall(NOTOK, ResetActiveView, iPaintManager*)(); }

Bool PaintManager::GetAllowSelectUpdate(){ PaintLibCall(NOTOK, GetAllowSelectUpdate, iPaintManager*)(); }
Bool PaintManager::SetAllowSelectUpdate(Bool _allowSelectUpdate){ PaintLibCall(NOTOK, SetAllowSelectUpdate, iPaintManager*)(_allowSelectUpdate); }
