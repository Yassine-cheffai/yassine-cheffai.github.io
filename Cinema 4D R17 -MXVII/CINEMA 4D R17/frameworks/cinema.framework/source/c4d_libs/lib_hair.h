...
#define HAIR_GUIDE_FLAGS_INITIAL			(1 << 3)			///< Chains are in their original initial space (like a stick texture tag).
...
public:
	...
	HairGuides *m_pHair;
	BaseList2D *m_pBase;
	const RayObject *m_pRayObject;
	HairMaterialData *m_pMaterial;
	Float32	*m_pThickness;
};
...
public:
	...
	Int32	flags;									///< The flags. @markPrivate
