...
public:
	...
	//----------------------------------------------------------------------------------------
	/// Returns SDKBrowserPluginInterfaceInfo::GetTypeNames(mode, no_strings) for the plugin.
	//----------------------------------------------------------------------------------------
...
public:
	...
	/// @param[in] mode								The mode. See @em SDKBrowserItemType above.
	/// @param[out] no_strings				Assigned the number of returned string descriptions.
	/// @return												The types descriptions. The caller owns the returned array and has to call bDelete() to free it.
	//----------------------------------------------------------------------------------------
