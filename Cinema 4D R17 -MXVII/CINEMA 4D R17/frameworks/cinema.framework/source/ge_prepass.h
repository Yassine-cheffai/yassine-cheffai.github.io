...
/// @ingroup group_enumeration
/// @{
/// Flags for EditorWindow::MouseDrag.
enum MOUSEDRAGFLAGS
{
	MOUSEDRAGFLAGS_0											= 0,						///< None.
	MOUSEDRAGFLAGS_DONTHIDEMOUSE					= (1 << 0),			///< Show the mouse pointer during drag.
	MOUSEDRAGFLAGS_NOMOVE									= (1 << 1),			///< Return if no mouse movement was done.
...
enum INITRENDERRESULT
{
	...
	INITRENDERRESULT_USERBREAK		= -103			///< Thread has been canceled. @since R17 Was @c INITRENDERRESULT_THREADEDLOCK.
...
enum MPBTYPE
{
	MPBTYPE_SHOW				= 1000,			///< ::Bool Get/Set. Determines if this layer will be shown in the external render window. (The @C4D renderer modifies this value itself.)
...
enum SPLINETYPE
{
	...
	RESERVEDSPLINETYPE1		= 5,		///< @markInternal @since R17
	RESERVEDSPLINETYPE2		= 6			///< @markInternal @since R17
...
enum NBIT
{
	...
	NBIT_CKEY_WEIGHTEDTANGENT = 84,			///< Weighted Tangent. @since R17
	NBIT_CKEY_REMOVEOVERSHOOT = 85,			///< Gradual Clamp of Tangent to avoid OverShooting. @since R17
	NBIT_CKEY_AUTOWEIGHT			= 86,			///< Weight still adjusted even if Angle is User Defined. @since R17
	NBIT_TAKE_LOCK						= 87,			///< A node in an override group cannot be changed. @since R17
	NBIT_TAKE_OBJINGROUP			= 88,			///< The object is overridden by an override group. @since R17
	NBIT_TAKE_EGROUPOVERIDDEN	= 89,			///< The object editor visibility is overridden by an override group. @since R17
	NBIT_TAKE_RGROUPOVERIDDEN	= 90,			///< The object render visibility is overridden by an override group. @since R17
...
#define BIT_ACTIVE3	(1 << 30)			///< @markPrivate @since R17
/// @}
/// @name Material Bits
/// @{
...
#define Xformula					1031433			///< Formula. @since R17
#define Xvariation				1033825 		///< Variation. @since R17
/// @}
...
#define WPREF_OPENGL_VIEWPORT_DITHERING				1091			///< ::Bool Enable Dithering in Viewport. @since R17
...
#define WPREF_COLOR_MODE_HEX										1111		///< ::Bool Hexadecimal Color Field. @since R17
#define WPREF_COLOR_MODE_RGB_OLD_SLIDERS 				1112  	///< ::Bool Use old-style RGB sliders. @since R17
#define WPREF_COLOR_MODE_HSV										1113		///< ::Bool HSV sliders mode. @since R17
#define WPREF_COLOR_MODE_KELVIN									1114		///< ::Bool Kelvin Color Temperature mode. @since R17
#define WPREF_COLOR_MODE_MIXER									1115		///< ::Bool Color Mixer mode. @since R17
#define WPREF_COLOR_MODE_SWATCHES								1116		///< ::Bool Color Swatches mode. @since R17
#define WPREF_COLOR_MODE_SWATCHES_SHOWNAMES 		1117		///< ::Bool Show Swatches Group Names. @since R17
#define WPREF_COLOR_MODE_SWATCHES_SWATCH_SIZE 	1118		///< ::Int32 Swatches Mode: swatch size. @since R17
...
#define WPREF_COLOR_MODE_WHEEL_SIZE							1120		///< ::Int32 Color Wheel Size. @since R17
#define WPREF_COLOR_MODE_WHEEL_SWATCH_SIZE			1121		///< ::Int32 Color Wheel Preview Swatches Size. @since R17
#define WPREF_COLOR_MODE_SPECTRUM_SIZE					1122		///< ::Int32 Spectrum Size. @since R17
#define WPREF_COLOR_MODE_PICTURE_SWATCH_SIZE		1123		///< ::Int32 Picture Mode Swatches Size. @since R17
...
enum
{
	...
	WPREFS_LINKKEYFCSELECTION,					///< ::Bool Link Keyframe and FCurve selection together. @since R17
	WPREFS_LINKOMSELECTONLY,						///< ::Bool Only display the actual selected object and not the tags etc. when Link Timeline/Object Manager is selected. @since R17
	//WPREFS_GLOBALSELECTION,						// Bool One global Timeline selection.
	WPREFS_LINKOMSELECTONLYBUTTAGS,			///< ::Bool Only display the linked objects but also the tags. @since R17
	WPREFS_FCLISTVIEW,									///< ::Bool FCurve mode only: list view instead of normal hierarchy. @since R17
	WPREFS_FCLISTVIEW_HIERARCHICAL,			///< ::Bool FCurve mode only: hierarchical list view instead of normal hierarchy. @since R17
};
/// @}
...
enum
{
	...
	WPREF_NET_USERMANAGEMENTENABLED										///< @since R17
...
#define EVMSG_TAKECHANGED						431000159			///< Sent by the Take System when the current Take ID changed to let all managers react to the new status. @since R17
...
enum EVENT
{
	...
	EVENT_ENQUEUE_REDRAW		= (1 << 5)			///< Do not stop the current redraw if @ref DrawViews() is running at the moment. In that case enqueue the redraw after the current draw is done. @since R17
...
enum RENDERFLAGS
{
	...
	RENDERFLAGS_DONTANIMATE						= (1 << 10)			///< Do not animate document before rendering. This should only be used in combination with @ref RENDERFLAGS_PREVIEWRENDER.@since R17
...
#define SHADERPOPUP_LOCATEIMAGE				99996			///< Show image in finder/explorer. (Only works for a single bitmap shader.) @since R17
...
enum VIDEOPOSTINFO
{
	...
	VIDEOPOSTINFO_REQUEST_MOTIONFULL		 	= (1 << 18), 			///< The videopost requires complete motion blur information. @since R17
...
#define VPPhLensDistortion		1031709			///< Videopost Lens Distortion. @since R17
...
enum DESCIDSTATE
{
	...
	DESCIDSTATE_OVERRIDE				= 1 << 2,			///< Description is overridden. @since R17
	DESCIDSTATE_FORBIDOVERRIDE	= 1 << 3			///< Description cannot be overridden. @since R17
...
enum CINEMAINFO
{
	...
	CINEMAINFO_FORBID_OGL			= 10,			///< Forbid OpenGL.
...
#define RENDERSETTING_STATICTAB_OVERRIDEMAT		8			///< %Render settings Global Material Override tab. @since R17
/// @}
