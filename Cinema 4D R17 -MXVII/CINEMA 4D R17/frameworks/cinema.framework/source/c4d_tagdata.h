...
public:
	...
	/// @warning Only draw in @ref DRAWPASS_HIGHLIGHTS if you really know what you are doing. Otherwise always check the drawpass and then do not draw if it is @ref DRAWPASS_HIGHLIGHTS.
