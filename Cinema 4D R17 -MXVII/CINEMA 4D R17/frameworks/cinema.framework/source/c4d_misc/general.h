...
#define	C4D_MISC_ALLOC_LOCATION		maxon::SourceLocation(__FILE__, __LINE__)
#define	C4D_MISC_ALLOC_LOCATION_DECLARATION	const maxon::SourceLocation& allocLocation
