...
#define C4DPL_SINGLEPRECISION_PLUGIN	0x1000			///< Indicates if a plugin was compiled for either single precision or double precision, so it will match the main @C4D build.

/// @addtogroup C4DPL_ERROR
/// @ingroup group_enumeration
/// @{
#define C4DPL_ERROR					-1			///< An unknown error occurred.
#define C4DPL_ERROR_TYPE		-2			///< @markPrivate
#define C4DPL_ERROR_VERSION	-3			///< Incorrect version of @C4D.
#define C4DPL_ERROR_OS			-4			///< Plugin will not work with this OS version.
#define C4DPL_ERROR_MEM			-5			///< Not enough memory.
/// @}
...
/// 			SetPriority(data, C4DPL_INIT_PRIORITY_PLUGINS+100);
/// 			return true;
/// 		case MY_MESSAGE:
/// 			...
/// 			return true;
