...
//----------------------------------------------------------------------------------------
	...
	/// @param[in] data								The message data. It is highly recommended that to own the pointed object and to not rely on the receiver to take the ownership.
...
/// @endcond
	...
	/// @param[in] format							The format: @enumerateEnum{FORMAT}
