...
public:
	...
	/// @code
	/// Bool ok = fn.FileSelect(FILESELECTTYPE_IMAGES, FILESELECT_SAVE, "Save", "bmp");
	/// @endcode
	...
	/// @markPrivate
	//----------------------------------------------------------------------------------------
	const MemoryFileStruct* GetMemoryModeI() const;
...
//----------------------------------------------------------------------------------------
/// Callback for FileMonitor.
/// @param[in] item								The filename of the monitored folder or file.
/// @param[in] flags							Currently unused, set to 0.
/// @param[out] userdata					The user data passed to the FileMonitor methods.
/// @return												Always @em 0.
//----------------------------------------------------------------------------------------
...
public:
	//----------------------------------------------------------------------------------------
	/// Starts monitoring of a folder.
	/// @param[in] folder							The filename of the folder to monitor.
	/// @param[in] callback						The folder monitor callback.
	/// @param[out] userdata					The user data passed to the callback function.
	/// @return												@trueIfOtherwiseFalse{folder monitoring could be started}
	//----------------------------------------------------------------------------------------
	static Bool WatchFolder(const Filename& folder, FileMonitorCallback callback, void* userdata);

	//----------------------------------------------------------------------------------------
	/// Stops monitoring of a folder.
	/// @param[in] folder							The filename of the folder to stop monitoring.
	/// @param[in] callback						The folder monitor callback function.
	/// @param[out] userdata					The user data passed to the callback function.
	/// @return												@trueIfOtherwiseFalse{folder monitoring could be stopped}
	//----------------------------------------------------------------------------------------
	static Bool DontWatchFolder(const Filename& folder, FileMonitorCallback callback, void* userdata);

	//----------------------------------------------------------------------------------------
	/// Starts monitoring of a file.
	/// @param[in] file								The filename of the file to monitor.
	/// @param[in] callback						The file monitor callback function.
	/// @param[out] userdata					The user data passed to the callback function.
	/// @return												@trueIfOtherwiseFalse{file monitoring could be started}
	//----------------------------------------------------------------------------------------
	static Bool WatchFile(const Filename& file, FileMonitorCallback callback, void* userdata);

	//----------------------------------------------------------------------------------------
	/// Stops monitoring of a file.
	/// @param[in] file								The filename of the file to stop monitoring.
	/// @param[in] callback						The file monitor callback function.
	/// @param[out] userdata					The user data passed to the callback function.
	/// @return												@trueIfOtherwiseFalse{file monitoring could be stopped}
	//----------------------------------------------------------------------------------------
...
public:
	...
	//----------------------------------------------------------------------------------------
	Bool WriteImage(BaseBitmap* bmp, Int32 format, BaseContainer* data, SAVEBIT savebits = SAVEBIT_ALPHA);
...
/// @param[in] date_only					If @formatConstant{true} only the values of day/month/year will be converted.
