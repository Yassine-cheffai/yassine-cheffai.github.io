...
void* GeDialog::AddCustomGui(Int32 id, Int32 pluginid, const String& name, Int32 flags, Int32 minw, Int32 minh, const BaseContainer& t_customdata)
{
...
Bool GeDialog::Open(DLG_TYPE dlgtype, Int32 pluginid, Int32 xpos, Int32 ypos, Int32 defaultw, Int32 defaulth, Int32 subid)
{
	if (!cd)
		return false;
	C4DOS.Cd->AddGadget(cd, DIALOG_SETIDS, pluginid, nullptr, subid, 0, 0, 0, nullptr, nullptr);
	return C4DOS.Cd->Open(cd, dlgtype, nullptr, xpos, ypos, defaultw, defaulth);
}
...
Bool GeDialog::SetBool(const GadgetPtr& id, Bool value, Int32 tristate)
{
...
Bool GeDialog::SetString(const GadgetPtr& id, const String& text, Int32 tristate, Int32 flags)
{
...
{
	return SetFloat(id, value, min / (Float) 100.0, max / (Float) 100.0, step / (Float) 100.0, FORMAT_PERCENT, 0.0, 0.0, false, tristate);
}
...
Bool GeDialog::GetTime(const GadgetPtr& id, const BaseDocument* doc, BaseTime& time) const
{
	...
	Float b;
	Bool	ok = GetFloat(id, b);
	time = BaseTime(b * (Float) 1000.0, fps * (Float) 1000.0);
	return ok;
}
...
C4DGadget* GeDialog::AddCheckbox(Int32 id, Int32 flags, Int32 initw, Int32 inith, const String& name)
{
	if (!cd)
		return nullptr;
	void* r = nullptr;
...
C4DGadget* GeDialog::AddRadioButton(Int32 id, Int32 flags, Int32 initw, Int32 inith, const String& name)
{
	if (!cd)
		return nullptr;
	void* r = nullptr;
...
C4DGadget* GeDialog::AddRadioText(Int32 id, Int32 flags, Int32 initw, Int32 inith, const String& name)
{
	if (!cd)
		return nullptr;
	void* r = nullptr;
...
C4DGadget* GeDialog::AddButton(Int32 id, Int32 flags, Int32 initw, Int32 inith, const String& name)
{
	if (!cd)
		return nullptr;
	void* r = nullptr;
...
C4DGadget* GeDialog::AddStaticText(Int32 id, Int32 flags, Int32 initw, Int32 inith, const String& name, Int32 borderstyle)
{
	if (!cd)
		return nullptr;
	void* r = nullptr;
...
C4DGadget* GeDialog::AddComboBox(Int32 id, Int32 flags, Int32 initw, Int32 inith, Bool specialalign)
{
	if (!cd)
		return nullptr;
	void* r = nullptr;
...
C4DGadget* GeDialog::AddComboButton(Int32 id, Int32 flags, Int32 initw, Int32 inith, Bool specialalign)
{
	if (!cd)
		return nullptr;
	void* r = nullptr;
...
C4DGadget* GeDialog::AddPopupButton(Int32 id, Int32 flags, Int32 initw, Int32 inith)
{
	if (!cd)
		return nullptr;
	void* r = nullptr;
...
Bool GeDialog::AddChild(const GadgetPtr& id, Int32 subid, const String& child)
{
	if (!cd)
		return false;
...
Bool GeDialog::GroupBegin(Int32 id, Int32 flags, Int32 cols, Int32 rows, const String& title, Int32 groupflags, Int32 initw, Int32 inith)
{
	if (!cd)
		return false;
...
Bool GeDialog::GetItemDim(const GadgetPtr& id, Int32* x, Int32* y, Int32* w, Int32* h)
{
...
Bool GeDialog::MenuAddString(Int32 id, const String& string)
{
...
{
	dlg_result = false;
	return GeDialog::Open(resizable ? DLG_TYPE_MODAL_RESIZEABLE : DLG_TYPE_MODAL, 0, xpos, ypos, defaultw, defaulth) && dlg_result;
}
...
void GeModalDialog::CheckLong(Int32 id, CHECKVALUERANGE type, Int32 val, Int32 x, Int32 y)
{
	...
	switch (type)
	{
		case CHECKVALUERANGE_GREATER:
			if (val > x)
				return;
			break;
		case CHECKVALUERANGE_GREATEROREQUAL:
			if (val >= x)
				return;
			break;
		case CHECKVALUERANGE_LESS:
			if (val < x)
				return;
			break;
		case CHECKVALUERANGE_LESSOREQUAL:
			if (val <= x)
				return;
			break;
		case CHECKVALUERANGE_BETWEEN:
			if (val > x && val < y)
				return;
			break;
		case CHECKVALUERANGE_BETWEENOREQUAL:
			if (val >= x && val <= y)
				return;
			break;
		case CHECKVALUERANGE_BETWEENOREQUALX:
			if (val >= x && val < y)
				return;
			break;
		case CHECKVALUERANGE_BETWEENOREQUALY:
			if (val > x && val <= y)
				return;
			break;
		case CHECKVALUERANGE_DIFFERENT:
			if (val != x)
				return;
			break;
	}
	...
	Activate(id);
	ErrorStringDialog(type, (Float)x, (Float)y, CHECKVALUEFORMAT_INT);
	close = false;
}
...
Int32 GeUserArea::GetWidth(void)
{
	return C4DOS.Cu->GetWidth(cu);
}

Int32 GeUserArea::GetHeight(void)
{
	return C4DOS.Cu->GetHeight(cu);
}

Int32 GeUserArea::GetId(void)
{
...
void GeUserArea::DrawBezier(Float sx, Float sy, Float* p, Int32 count, Bool closed, Bool filled)
{
	C4DOS.Cu->DrawBezier(cu, sx, sy, p, count, closed, filled);
}

void GeUserArea::DrawLine(Int32 x1, Int32 y1, Int32 x2, Int32 y2)
{
...
Bool GeUserArea::GetColorRGB(Int32 colorid, Int32& r, Int32& g, Int32& b)
{
...
Bool GeUserArea::IsHotkeyDown(Int32 id)
{
	return C4DOS.Cu->IsHotkeyDown(cu, id);
}

void GeUserArea::GetBorderSize(Int32 type, Int32* l, Int32* t, Int32* r, Int32* b)
{
...
Bool GeUserArea::GetInputState(Int32 askdevice, Int32 askchannel, BaseContainer& res)
{
	return C4DOS.Cu->GetInputState((CBaseFrame*)cu, askdevice, askchannel, &res);
}

Bool GeUserArea::GetInputEvent(Int32 askdevice, BaseContainer& res)
{
...
Int32 GeUserArea::DrawGetTextWidth(const String& text)
{
	return C4DOS.Cu->DrawGetTextWidth(cu, (String*)&text);
}

Int32 GeUserArea::DrawGetTextWidth_ListNodeName(BaseList2D* node, Int32 fontid)
{
...
Int32 GeUserArea::DrawGetFontHeight()
{
	return C4DOS.Cu->DrawGetFontHeight(cu);
}

Int32 GeUserArea::DrawGetFontBaseLine()
{
...
void GeUserArea::DrawText(const String& txt, Int32 x, Int32 y, Int32 flags)
{
...
Bool GeUserArea::Global2Local(Int32* x, Int32* y)
{
	return C4DOS.Cu->Global2Local((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Local2Global(Int32* x, Int32* y)
{
	return C4DOS.Cu->Local2Global((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Local2Screen(Int32* x, Int32* y)
{
	return C4DOS.Cu->Local2Screen((CBaseFrame*)cu, x, y);
}

Bool GeUserArea::Screen2Local(Int32* x, Int32* y)
{
...
Bool GeUserArea::GetDragObject(const BaseContainer& msg, Int32* type, void** object)
{
	return dlg->GetDragObject(msg, type, object);
}

Bool GeUserArea::GetDragPosition(const BaseContainer& msg, Int32* x, Int32* y)
{
	if (x)
		*x = msg.GetInt32(BFM_DRAG_SCREENX);
	if (y)
...
{
	return C4DOS.Cd->GetInterfaceScheme(type);
}
...
Bool GeDialog::CheckCoreMessage(const BaseContainer& msg, Int32* ownlastcoremsg)
{
	...
	if (coremsg == *storage)
		return false;
	if (coremsg == msg.GetInt32(BFM_CORE_ID) && ((UInt)msg.GetVoid(BFM_CORE_PAR1) & (UInt)EVENT_GLHACK))
		return false;
	*storage = coremsg;
	return true;
}
...
void ProgressDialog::Timer(const BaseContainer& msg)
{
	...
	if (callback)	// is there a one-time callback that should be called from the main thread
	{
		...
		if (callback)
		{
			...
			callback_context = nullptr;
			callback = nullptr;	// clear the callback pointer (callback has been executed)
		}
		else
		{
			CriticalStop();
...
Int32 ProgressDialog::Message(const BaseContainer& msg, BaseContainer& result)
{
	switch (msg.GetId())
	{
		...
		case BFM_CORE_MESSAGE:
		{
			switch (msg.GetInt32(BFM_CORE_ID))
			{
