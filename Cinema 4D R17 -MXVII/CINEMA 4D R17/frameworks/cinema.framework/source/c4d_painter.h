...
#define PAINTER_SAVETEXTURE_DIRECT	1005			///< @markUnused
...
#define GETACTIVEUVSET_ALL									(0xFFFF & ~GETACTIVEUVSET_CHECKENABLING)			///< Combines all of the previous flags except the enable status.
/// @}
...
#define UVCOMMAND_COPY_UV											10004			///< Copy UV Points.
#define UVCOMMAND_PASTE_UV										10005			///< Paste UV Points.
#define UVCOMMAND_MAX_UV											10006			///< Max UV.
#define UVCOMMAND_FLIP_SEQUENCE								10007			///< Flip Sequence.
#define UVCOMMAND_MOVE_DOWN_SEQUENCE					10008			///< Move Down Sequence.
#define UVCOMMAND_MOVE_UP_SEQUENCE						10009			///< Move Up Sequence.
...
public:
	...
	//----------------------------------------------------------------------------------------
	void ApplyAlphaMask(Int32 x, Int32 y, Int32 cnt, PIX* bits, Int32 mode, Bool inverted, Int32 flags) { C4DOS.Pa->PB_ApplyAlphaMask(this, x, y, cnt, bits, mode, inverted, flags); }
	...
	/// @param[in] flags							Reserved, must be @ref DIRTYFLAGS_0.
...
#define TEXTURE_MODE						1003			///< ::Int32 Texture mode (only non-alpha channel modes):\n
																					///< @ref COLORMODE_GRAY, @ref COLORMODE_RGB, @ref COLORMODE_RGBw, @ref COLORMODE_GRAYw, @ref COLORMODE_RGBf, @ref COLORMODE_GRAYf
