...
void FillNodePlugin(NODEPLUGIN* np, Int32 info, DataAllocator* g, BaseBitmap* icon, Int32 disklevel, void* emulation)
{
	np->Allocator	 = g;
...
Bool RegisterNodePlugin(Int32 id, const String& str, Int32 info, DataAllocator* g, BaseBitmap* icon, Int32 disklevel, Int32* fallback)
{
	...
	return GeRegisterPlugin(PLUGINTYPE_NODE, id, str, &np, sizeof(np));
}
