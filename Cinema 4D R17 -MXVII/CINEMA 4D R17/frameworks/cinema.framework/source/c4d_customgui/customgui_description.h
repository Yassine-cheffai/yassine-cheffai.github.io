...
#define DESCRIPTION_NO_TAKE_OVERRIDES		'ntov'			///< ::Bool: If @formatConstant{true} ignore the overrides enabling/disabling. @since R17
#define DESCRIPTION_SINGLEDESC_MODE			'sing'			///< @markPrivate @since R17
/// @}
