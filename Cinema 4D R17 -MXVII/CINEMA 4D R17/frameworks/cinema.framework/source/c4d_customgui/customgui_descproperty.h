...
#define DESCPROP_NOTOVERRIDE				(1 << 18)			///< Parameter is not overridden. @since R17
#define DESCPROP_AUTOTAKE						(1 << 19)			///< Description is enabled for Auto Take. @since R17
#define DESCPROP_INVERTENABLING			(1 << 20)			///< Description enabling defined by override from Take has to be inverted. @since R17
/// @}
