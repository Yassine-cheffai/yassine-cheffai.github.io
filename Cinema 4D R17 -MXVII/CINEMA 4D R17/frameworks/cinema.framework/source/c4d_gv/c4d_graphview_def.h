...
enum GvMessage
{
	...
	///< Add port. @markDeprecated
	GV_MESSAGE_REMOVE_PORT_EX,
	///< Remove port. @markDeprecated
...
{
	Int32						count;				///< Number of elements in the arrays.
	GvDataID*				types;				///< Array of data IDs.
	UInt32*					flags;				///< Array of port flags.
	Int32*					ids;					///< Array of port IDs.
	Int32*					name_ids;			///< Not used.
	const String**	names;				///< Array of port names.
};
...
struct GvValuesInfo
{
	...
	/// Constructor.
	//----------------------------------------------------------------------------------------
	GvValuesInfo() : in_values(nullptr), out_ports(nullptr), nr_of_in_values(0), nr_of_out_ports(0) { }

	GvValue**	in_values;						///< Array of input values.
	GvPort**	out_ports;						///< Array of output ports.
	Int32			nr_of_in_values;			///< Number of input values.
	Int32			nr_of_out_ports;			///< Number of output ports.
...
struct GvDrawHook
{
	...
	Int32						flags;						///< The pass: @enumerateEnum{SCENEHOOKDRAW}
};
