...
struct C4D_Shader
{
	...
	Float						(*CalcAmbientOcclusion					)(VolumeData *sd, SurfaceIntersection *pSI, RaySampler *sampler, Float minlength, Float maxlength, Float index, Bool self, Bool trans, Float weight);
...
struct C4D_CAnimation
{
	...
	CKey*						(CCurve::*AddKeyAdaptTangent	)(const BaseTime &time, Bool bUndo, Int32 *nidx);
...
struct C4D_General
{
	...
	Bool						(*EwBfIsHotkeyDown							)(EditorWindow *win, Int32 id);
...
struct C4D_GLSL
{
	...
	UInt32						(*GetLanguageFeatures)(Int32 lCompiler, Int32 lFlags);
