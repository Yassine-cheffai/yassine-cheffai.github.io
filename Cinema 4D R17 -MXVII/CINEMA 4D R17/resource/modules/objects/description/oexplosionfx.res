CONTAINER Oexplosionfx
{
	...
	{
		REAL EXPLOSIONFX_TIME { MIN 0.0; MAX 100.0; STEP 0.1; UNIT PERCENT; }
	}
	GROUP ID_EXPLOSIONFX_EXPLOSION
	{
		REAL EXPLOSIONFX_EXPLOSTRENGTH { MIN 0.0; STEP 1.0; }
		REAL EXPLOSIONFX_EXPLOSTRENGTH_FALLOFF { PARENTID EXPLOSIONFX_EXPLOSTRENGTH; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
		REAL EXPLOSIONFX_EXPLOSTRENGTH_RANDOM { PARENTID EXPLOSIONFX_EXPLOSTRENGTH; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
		SEPARATOR { LINE; }
		...
		REAL EXPLOSIONFX_EXPLODIRECTION_RANDOM { PARENTID EXPLOSIONFX_EXPLODIRECTION; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
		SEPARATOR { LINE; }
		REAL EXPLOSIONFX_EXPLOTIME { MIN 0.0; STEP 1.0; }
		SEPARATOR { LINE; }
		REAL EXPLOSIONFX_DSPEED { MIN 0.0; STEP 1.0; }
		REAL EXPLOSIONFX_DSPEED_FALLOFF { PARENTID EXPLOSIONFX_DSPEED; MIN 0; MAX 100; STEP 1.0; UNIT PERCENT; }
		REAL EXPLOSIONFX_DSPEED_RANDOM { PARENTID EXPLOSIONFX_DSPEED; MIN 0; MAX 100; STEP 1.0; UNIT PERCENT; }
		SEPARATOR { LINE; }
		REAL EXPLOSIONFX_DMAX_RANGE { MIN 0.0; STEP 1.0; UNIT METER; }
		REAL EXPLOSIONFX_DMAX_RANGE_RANDOM { PARENTID EXPLOSIONFX_DMAX_RANGE; MIN 0; MAX 100; STEP 1.0; UNIT PERCENT; }
	}

	GROUP ID_EXPLOSIONFX_CLUSTER
	{
		REAL EXPLOSIONFX_THICKNESS { UNIT METER; STEP 1.0; }
		REAL EXPLOSIONFX_THICKNESS_RANDOM { PARENTID EXPLOSIONFX_THICKNESS; MIN 0; MAX 100; UNIT PERCENT; }
		SEPARATOR { LINE; }
		REAL EXPLOSIONFX_DENSITY { MIN 0.0; STEP 1.0; }
		REAL EXPLOSIONFX_DENSITY_RANDOM { PARENTID EXPLOSIONFX_DENSITY; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
		SEPARATOR { LINE; }
	...
	GROUP ID_EXPLOSIONFX_GRAVITY
	{
		...
		REAL EXPLOSIONFX_GRAVITATION_RANDOM { PARENTID EXPLOSIONFX_GRAVITATION; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
		SEPARATOR { }
		...
		REAL EXPLOSIONFX_GMAX_RANGE_RANDOM { PARENTID EXPLOSIONFX_GMAX_RANGE; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
	}

	GROUP ID_EXPLOSIONFX_ROTATION
	{
		REAL EXPLOSIONFX_WSPEED { STEP 1.0; }
		REAL EXPLOSIONFX_WSPEED_FALLOFF { PARENTID EXPLOSIONFX_WSPEED; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
		REAL EXPLOSIONFX_WSPEED_RANDOM { PARENTID EXPLOSIONFX_WSPEED; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
		SEPARATOR { }
		...
		REAL EXPLOSIONFX_ROTACHSE_RANDOM { PARENTID EXPLOSIONFX_ROTACHSE; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
	}
	...
	GROUP ID_EXPLOSIONFX_SPECIALS
	{
		...
		REAL EXPLOSIONFX_WINDSPEED_RANDOM { PARENTID EXPLOSIONFX_WINDSPEED; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
		REAL EXPLOSIONFX_WIRBELSPEED { STEP 1.0; }
		REAL EXPLOSIONFX_WIRBELSPEED_RANDOM { PARENTID EXPLOSIONFX_WIRBELSPEED; MIN 0.0; MAX 100.0; STEP 1.0; UNIT PERCENT; }
	}
}
