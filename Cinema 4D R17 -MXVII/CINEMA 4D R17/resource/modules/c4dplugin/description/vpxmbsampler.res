CONTAINER VPxmbsampler
{
	...
	GROUP VP_XMB_GROUP_RAYTRACING_DEBUG
	{
		...
		LONG VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE	
		{ 
			ANIM OFF; 
			CYCLE
			{
				VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE_DEFAULT;
				VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE_1V;
				VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE_4V;
				VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE_1I;
				VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE_4I;
				VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE_1;
				VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE_4;
				VP_XMB_RAYTRACING_DEBUG_EMBREE_TRIANGLE_1P;
			}
		}

		REAL VP_XMB_RAYTRACING_DEBUG_EMBREE_NEAR	{ ANIM OFF; MIN 10.0; }

		LONG VP_XMB_RAYTRACING_DEBUG_EMBREE_SCALE
		{
			ANIM OFF;
		}
